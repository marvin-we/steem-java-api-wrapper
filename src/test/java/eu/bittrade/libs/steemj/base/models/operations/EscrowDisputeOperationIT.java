...
import eu.bittrade.libs.steemj.base.models.operations.EscrowDisputeOperation;
...
public class EscrowDisputeOperationIT extends BaseIntegrationTest {
    ...
    public void testOperationParsing() throws SteemCommunicationException {
        SignedBlockWithInfo blockContainingEscrowDisputeOperation = steemApiWrapper.getBlock(BLOCK_NUMBER_CONTAINING_OPERATION);
