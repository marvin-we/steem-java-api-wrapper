...
import eu.bittrade.libs.steemj.base.models.operations.EscrowApproveOperation;
...
public class EscrowApproveOperationIT extends BaseIntegrationTest {
    ...
    public void testOperationParsing() throws SteemCommunicationException {
        SignedBlockWithInfo blockContainingApproveOperation = steemApiWrapper.getBlock(BLOCK_NUMBER_CONTAINING_OPERATION);
