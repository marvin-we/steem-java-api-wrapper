...
import eu.bittrade.libs.steemj.base.models.operations.EscrowReleaseOperation;
...
public class EscrowReleaseOperationIT extends BaseIntegrationTest {
    ...
    public static void prepareTestClass() throws Exception {
        ...
        EscrowReleaseOperation escrowReleaseOperation = new EscrowReleaseOperation();

        escrowReleaseOperation.setAgent(new AccountName("steemj"));
        escrowReleaseOperation.setFrom(new AccountName("dez1337"));
        escrowReleaseOperation.setTo(new AccountName("dez1337"));
        escrowReleaseOperation.setWho(new AccountName("dez1337"));
        escrowReleaseOperation.setReceiver(new AccountName("dez1337"));
        escrowReleaseOperation.setEscrowId(34);

        Asset sbdAmount = new Asset();
        sbdAmount.setAmount(1L);
        sbdAmount.setSymbol(AssetSymbolType.SBD);

        escrowReleaseOperation.setSbdAmount(sbdAmount);

        Asset steemAmount = new Asset();
        steemAmount.setAmount(10L);
        steemAmount.setSymbol(AssetSymbolType.STEEM);

        escrowReleaseOperation.setSteemAmount(steemAmount);
    ...
    public void testOperationParsing() throws SteemCommunicationException {
        SignedBlockWithInfo blockContainingEscrowReleaseOperation = steemApiWrapper.getBlock(BLOCK_NUMBER_CONTAINING_OPERATION);
