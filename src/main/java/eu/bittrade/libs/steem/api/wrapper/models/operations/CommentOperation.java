    ...
    public byte[] toByteArray() throws SteemInvalidTransactionException {
        try (ByteArrayOutputStream serializedCommentOperation = new ByteArrayOutputStream()) {
            serializedCommentOperation
                    .write(Utils.transformIntToVarIntByteArray(OperationType.COMMENT_OPERATION.ordinal()));
            serializedCommentOperation.write(this.parentAuthor.toByteArray());
            serializedCommentOperation.write(Utils.transformStringToVarIntByteArray(this.parentPermlink));
            serializedCommentOperation.write(this.author.toByteArray());
            serializedCommentOperation.write(Utils.transformStringToVarIntByteArray(this.permlink));
            serializedCommentOperation.write(Utils.transformStringToVarIntByteArray(this.title));
            serializedCommentOperation.write(Utils.transformStringToVarIntByteArray(this.body));
            serializedCommentOperation.write(Utils.transformStringToVarIntByteArray(this.jsonMetadata));
