...
public class CreateClaimedAccountOperation extends AccountCreateOperation {
    ...
    /**
     * Create a claim created account operation. Use this operation to claim an
     * account. This operation is the same as {@link AccountCreateOperation}
     *
     * @param creator
     ...
     */
    @JsonCreator
    public CreateClaimedAccountOperation(@JsonProperty("creator") AccountName creator, @JsonProperty("fee") Asset fee,
