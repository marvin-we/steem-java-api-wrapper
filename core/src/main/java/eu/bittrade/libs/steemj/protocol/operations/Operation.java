...
@JsonSubTypes({ @Type(value = VoteOperation.class, name = "vote_operation"),
        ...
        @Type(value = AccountCreateOperation.class, name = "account_create_operation_operation"),
        ...
        // Virtual Operations
        @Type(value = AuthorRewardOperation.class, name = "author_reward_operation_operation"),
        @Type(value = CommentBenefactorRewardOperation.class, name = "comment_benefactor_reward_operation_operation"),
        @Type(value = CommentPayoutUpdateOperation.class, name = "comment_payout_update_operation_operation"),
        @Type(value = CommentRewardOperation.class, name = "comment_reward_operation_operation"),
        @Type(value = CurationRewardOperation.class, name = "curation_reward_operation_operation"),
        @Type(value = FillConvertRequestOperation.class, name = "fill_convert_request_operation_operation"),
        @Type(value = FillOrderOperation.class, name = "fill_order_operation_operation"),
        @Type(value = FillTransferFromSavingsOperation.class, name = "fill_transfer_from_savings_operation_operation"),
        @Type(value = FillVestingWithdrawOperation.class, name = "fill_vesting_withdraw_operation_operation"),
        @Type(value = HardforkOperation.class, name = "hardfork_operation_operation"),
        @Type(value = InterestOperation.class, name = "interest_operation_operation"),
        @Type(value = LiquidityRewardOperation.class, name = "liquidity_reward_operation_operation"),
        @Type(value = ReturnVestingDelegationOperation.class, name = "return_vesting_delegation_operation_operation"),
        @Type(value = ShutdownWitnessOpeartion.class, name = "shutdown_witness_operation_operation"),
        @Type(value = ProducerRewardOperation.class, name = "producer_reward_operation_operation") })
